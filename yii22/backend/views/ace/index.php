			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="<?= Url::toRoute(['ace/typography'])?>">
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="<?= Url::toRoute(['ace/elements'])?>">
								...
								<li>
									<a href="<?= Url::toRoute(['ace/buttons'])?>">
										<i class="icon-double-angle-right"></i>
										按钮 &amp; 图表
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/treeview'])?>">
										<i class="icon-double-angle-right"></i>
										树菜单
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/jquery_ui'])?>">
										<i class="icon-double-angle-right"></i>
										jQuery UI
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/nestable_list'])?>">
										<i class="icon-double-angle-right"></i>
										可拖拽列表
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="<?= Url::toRoute(['ace/form_elements'])?>">
										<i class="icon-double-angle-right"></i>
										表单组件
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/form_wizard'])?>">
										<i class="icon-double-angle-right"></i>
										向导提示 &amp; 验证
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/wysiwyg'])?>">
										<i class="icon-double-angle-right"></i>
										编辑器
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/dropzone'])?>">
										<i class="icon-double-angle-right"></i>
										文件上传
									</a>
								</li>
						...
						<li>
							<a href="<?= Url::toRoute(['ace/widgets'])?>">
						...
						<li>
							<a href="<?= Url::toRoute(['ace/calendar'])?>">
						...
						<li>
							<a href="<?= Url::toRoute(['ace/gallery'])?>">
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="<?= Url::toRoute(['ace/profile'])?>">
										<i class="icon-double-angle-right"></i>
										用户信息
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/pricing'])?>">
										<i class="icon-double-angle-right"></i>
										售价单
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/invoice'])?>">
										<i class="icon-double-angle-right"></i>
										购物车
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/timeline'])?>">
										<i class="icon-double-angle-right"></i>
										时间轴
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="<?= Url::toRoute(['ace/error_404'])?>">
										<i class="icon-double-angle-right"></i>
										404错误页面
									</a>
								</li>
								...
								<li>
									<a href="<?= Url::toRoute(['ace/error_500'])?>">
										<i class="icon-double-angle-right"></i>
										500错误页面
									</a>
								</li>
						...
						<div>
							<div class="pull-left">
								<select id="skin-colorpicker" class="hide">
									<option data-ski#438EB9</option>
									<option data-sk#222A2D</option>
									<option data-sk#C6487E</option>
									<option data-sk#D0D0D0</option>
								</select>
							</div>
							<span>&nbsp; 选择皮肤</span>
						</div>
